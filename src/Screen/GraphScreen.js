...
const villa = [
    {
        "property": {
            ...
            "description": "The property boasts top-of-the-line security, ample parking, and proximity to embassies, high-end dining, and shopping areas, making it the perfect residence for diplomats or high-profile individuals.",
            "userId": "U66625880309",
            "availability": true,
            "sold": false,
            "location": {
    ...
    },
    {
        "property": {
            ...
            "description": "The villa has been designed with a modern aesthetic, featuring high ceilings, spacious rooms, and luxurious finishes.",
            "userId": "U66001502490",
            "availability": true,
            "sold": false,
            "location": {
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    ...
                    >
                            ...
                            <View style={styles.textContainer}>
                                        ...
                                        >
                                            ...
                                            <View style={styles.areaContainer}>
                                                <Text
                                                    ...
                                                    ellipsizeMode="tail">
                                                    {item.Property_Details.plotArea ? item.Property_Details.plotArea : item.Property_Details.coveredArea ? item.Property_Details.coveredArea : item.Property_Details.totalArea} sq.ft
                                                </Text>
                                ...
                                <View style={styles.addressContainer}>
                                    <Text
                                        ...
                                        {item.property.location.address},{item.property.location.city}
                                    </Text>
                                </View>
                                ...
                                <>
                                        ...
                                        <View style={styles.availabilityContainer}>
                                            <Text style={styles.balconiesText}
                                                numberOfLines={1} // Limits text to a single line
                                                ellipsizeMode="tail">
                                ...
                                <View style={styles.lowerConatiner}>
                                    <View style={styles.priceContainer}>
                                        <Text style={styles.priceText}>
                                            INR {formatCost(item?.property?.priceDetails?.total) || "N/A"}
                                        </Text>
                                    </View>
                                    <TouchableOpacity
                        ...
                        <View style={styles.statusMainConatiner}>
